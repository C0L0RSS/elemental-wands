...
overheated values. Screenshots in `docs/archive/evidence/fire-build-verification/` use fixture state
...
are saved beside the screenshots in `docs/archive/evidence/fire-build-verification/`.
