...
public final class ModParticles {
    ...
    public static final SimpleParticleType FIRE_METEOR_SHELL = register("fire_meteor_shell", true);
    // The contracting landing ring remains readable on Minimal particles.
