...
public class WandUtils {
    ...
    public static HitResult raycast(World world, Entity caster, double range) {
        ...
        Predicate<Entity> predicate = (e) ->
                e != caster && e.isAlive() && e.canHit() && !e.isSpectator();

        // 1.21.x changed ProjectileUtil#getEntityCollision to require a ProjectileEntity.
        // We *aren't* a projectile here, so we do a small manual raycast against entity hitboxes.
